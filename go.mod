...
require (
	...
	github.com/projectsveltos/addon-controller v0.57.1
	github.com/projectsveltos/event-manager v0.57.1
	github.com/projectsveltos/libsveltos v0.57.3-0.20250706132153-6f2f96f68b4f
