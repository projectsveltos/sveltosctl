...
require (
	...
	github.com/projectsveltos/addon-controller v1.0.1-0.20250904053416-27660cf8a7e0
	github.com/projectsveltos/event-manager v1.0.1-0.20250831124102-f817a7166173
	github.com/projectsveltos/libsveltos v1.0.1-0.20250901165130-eecfa7502274
