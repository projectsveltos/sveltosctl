...
require (
	...
	github.com/projectsveltos/addon-controller v0.11.1-0.20230630082934-0471c9dbc13b
	github.com/projectsveltos/event-manager v0.11.1-0.20230630094111-91ba332ba759
