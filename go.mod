...
require (
	...
	github.com/projectsveltos/libsveltos v0.7.2-0.20230314175637-cecbf1f2a756
	github.com/projectsveltos/sveltos-manager v0.7.1-0.20230316204759-4dd2231bda49
