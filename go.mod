...
require (
	...
	github.com/projectsveltos/addon-controller v0.22.1-0.20240125131109-047a56063d83
	github.com/projectsveltos/event-manager v0.22.1-0.20240125134456-e85a59ffa7e2
