...
require (
	...
	github.com/projectsveltos/libsveltos v0.7.2-0.20230317221215-fd97fbf75a5e
	github.com/projectsveltos/sveltos-manager v0.7.1-0.20230317225810-1cd3479d82a0
