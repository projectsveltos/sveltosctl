...
require (
	...
	github.com/projectsveltos/addon-controller v1.1.1-0.20250914053618-870616ee9ebf
	github.com/projectsveltos/event-manager v1.1.1-0.20250914074831-e27ab34932dc
