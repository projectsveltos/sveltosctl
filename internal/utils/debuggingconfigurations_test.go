...
var _ = Describe("DebuggingConfigurations", func() {
	...
	It("UpdateDebuggingConfiguration updates default DebuggingConfiguration instance", func() {
		...
		k8sAccess := utils.GetK8sAccess(scheme, c)
		Expect(k8sAccess.UpdateDebuggingConfiguration(context.TODO(), dc, dc.Name, "", "")).To(Succeed())
		...
		Expect(k8sAccess.UpdateDebuggingConfiguration(context.TODO(), currentDC, dc.Name, "", "")).To(Succeed())
