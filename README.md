...
```
kubectl create -f  https://raw.githubusercontent.com/projectsveltos/sveltosctl/v0.4.1/manifest/utils.projectsveltos.io_snapshots.yaml

kubectl create -f  https://raw.githubusercontent.com/projectsveltos/sveltosctl/v0.4.1/manifest/sveltosctl.yaml
```
